...
public class AbandonedOrdersLegacyUIControllers {
	...
	private OrderFrequenciesController orderFrequenciesController = new OrderFrequenciesController();
	
	private OtherDrugOrderAttributesFormController otherDrugOrderAttributesFormController = new OtherDrugOrderAttributesFormController();
	...
	public void deleteFromOrderFrequenciesList(HttpServletRequest request, HttpServletResponse response) {
		...
		request.getSession().setAttribute(WebConstants.OPENMRS_MSG_ATTR, "Successfully deleted Selected Order Frequencies");
	...
	public void submitManageOtherDrugOrderAttributesPage(ModelMap model) {
